...
import com.android.evindroid.ucenici.UceniciListView;
	...
	public boolean onContextItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.modify_ucenik:
				...
				//ucenikDetailsIntent.putParcelableArrayListExtra("ucenici", (ArrayList<? extends Parcelable>)uceniciListView.getArrUcenici());
